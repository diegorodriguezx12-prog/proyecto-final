...
do
{
    Console.Clear();
    Console.WriteLine("====================================================");
    Console.WriteLine("   SIMULADOR DE STREAMING - FACULTAD DE INGENIERÍA");
    Console.WriteLine("====================================================");
...
void MostrarEstadisticas()
{
    ...
    Console.WriteLine("Aprobados: " + publicados);
    Console.WriteLine("Rechazados: " + rechazados);
    Console.WriteLine("Revisión: " + enRevision);
...
{
    totalEvaluados = 0; publicados = 0; rechazados = 0; enRevision = 0;
    impactoAltoCount = 0; impactoMedioCount = 0; impactoBajoCount = 0;
